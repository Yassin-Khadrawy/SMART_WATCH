...
typedef struct{
    ...
    unit8 voltage_reference : 1;              /* Voltage Reference Configuration */
    unit8 result_format : 1;                  /* A/D Result Format Select */
    unit8 ADC_Reserved : 6;
}adc_conf_t;

/**
 * Result size of an A/D conversion
 */
typedef unit16 adc_result_t;
...
Std_ReturnType ADC_IsConversionDone(const adc_conf_t *_adc, unit8 *conversion_status);
